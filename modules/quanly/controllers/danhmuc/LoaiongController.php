 ...
 */
class LoaiongController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Loại ống";
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Thêm mới Loại ống",
                    'content'=>'<span class="text-success">Thêm mới Loại ống thành công</span>',
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-light float-right','data-bs-dismiss'=>"modal"]).
                            Html::a('Tiếp tục thêm mới',['create'],['class'=>'btn btn-primary float-left','role'=>'modal-remote'])
                ];
            }else{
                return [
                    'title'=> "Create new Loại ống",
                    'content'=>$this->renderAjax('create', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-light float-right','data-bs-dismiss'=>"modal"]).
