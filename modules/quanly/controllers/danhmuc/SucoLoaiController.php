 ...
 */
class SucoLoaiController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Loại sự cố";
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Thêm mới Loại sự cố",
                    'content'=>'<span class="text-success">Thêm mới Loại sự cố thành công</span>',
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-light float-right','data-bs-dismiss'=>"modal"]).
                            Html::a('Tiếp tục thêm mới',['create'],['class'=>'btn btn-primary float-left','role'=>'modal-remote'])
                ];
            }else{
                return [
                    'title'=> "Create new Loại sự cố",
                    'content'=>$this->renderAjax('create', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-light float-right','data-bs-dismiss'=>"modal"]).
