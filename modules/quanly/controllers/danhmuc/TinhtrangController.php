...
use app\modules\quanly\models\danhmuc\DmTinhtrangSearch;
...
class TinhtrangController extends \app\modules\quanly\base\QuanlyBaseController
{
    ...
    {
        $searchModel = new DmTinhtrangSearch();
    ...
    /**
     * Displays a single DmTinhtrang model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new DmTinhtrang model.
    ...
    /**
     * Updates an existing DmTinhtrang model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing DmTinhtrang model.
     * For ajax request will return json object
    ...
    /**
     * Finds the DmTinhtrang model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return DmTinhtrang the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = DmTinhtrang::findOne($id)) !== null) {
            return $model;
        } else {
