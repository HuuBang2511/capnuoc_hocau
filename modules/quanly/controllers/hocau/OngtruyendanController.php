...
use app\modules\quanly\models\hocau\OngtruyendanSearch;
    ...
    public function actionCreate()
    {
        ...
        if ($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())) {
            ...
            if ($filedinhkem->fileupload != null) {
                $file        = [];
                $relative    = 'uploads/ongtruyendan/' . $model->id . '/';
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title'       => "Xóa Ống nước thô thành công #" . $id,
