...
/**
 * DmHieudonghoSearch represents the model behind the search form about `app\modules\quanly\models\danhmuc\DmHieudongho`.
 */
class DmHieudonghoSearch extends DmHieudongho
{
    /**
     * @inheritdoc
     */
