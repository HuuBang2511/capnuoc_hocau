...
/**
 * DmLoaihamSearch represents the model behind the search form about `app\modules\quanly\models\danhmuc\DmLoaiham`.
 */
class DmLoaihamSearch extends DmLoaiham
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = DmLoaiham::find()->where(['status' => 1]);
