...
/**
 * DmLoaimoinoiSearch represents the model behind the search form about `app\modules\quanly\models\danhmuc\DmLoaimoinoi`.
 */
class DmLoaimoinoiSearch extends DmLoaimoinoi
{
    /**
     * @inheritdoc
     */
