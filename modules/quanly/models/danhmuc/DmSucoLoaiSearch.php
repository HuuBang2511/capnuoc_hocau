...
/**
 * DmSucoLoaiSearch represents the model behind the search form about `app\modules\quanly\models\danhmuc\DmSucoLoai`.
 */
class DmSucoLoaiSearch extends DmSucoLoai
{
    /**
     * @inheritdoc
     */
