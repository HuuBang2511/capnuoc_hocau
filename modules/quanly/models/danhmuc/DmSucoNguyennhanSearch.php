...
/**
 * DmSucoNguyennhanSearch represents the model behind the search form about `app\modules\quanly\models\danhmuc\DmSucoNguyennhan`.
 */
class DmSucoNguyennhanSearch extends DmSucoNguyennhan
{
    /**
     * @inheritdoc
     */
