...
/**
 * DmSucoTinhtrangSearch represents the model behind the search form about `app\modules\quanly\models\danhmuc\DmSucoTinhtrang`.
 */
class DmSucoTinhtrangSearch extends DmSucoTinhtrang
{
    /**
     * @inheritdoc
     */
