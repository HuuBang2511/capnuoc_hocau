...
/**
 * DonghonhamaySearch represents the model behind the search form about `app\modules\quanly\models\hocau\Donghonhamay`.
 */
class DonghonhamaySearch extends Donghonhamay
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Donghonhamay::find()->where(['status' => 1]);
