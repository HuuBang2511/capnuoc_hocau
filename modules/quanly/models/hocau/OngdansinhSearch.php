...
/**
 * OngdansinhSearch represents the model behind the search form about `app\modules\quanly\models\hocau\Ongdansinh`.
 */
class OngdansinhSearch extends Ongdansinh
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Ongdansinh::find()->where(['status' => 1]);
