...
/**
 * This is the model class for table "network_ongphanphoi".
 *
 * @property int $id
...
class Ongphanphoi extends QuanlyBaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['objectid_1', 'objectid', 'coong', 'status', 'created_by', 'updated_by'], 'default', 'value' => null],
            [['objectid_1', 'objectid', 'coong', 'status', 'created_by', 'updated_by'], 'integer'],
