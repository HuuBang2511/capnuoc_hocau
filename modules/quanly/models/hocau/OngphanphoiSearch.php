...
/**
 * OngphanphoiSearch represents the model behind the search form about `app\modules\quanly\models\hocau\Ongphanphoi`.
 */
class OngphanphoiSearch extends Ongphanphoi
{
    /**
     * @inheritdoc
     */
