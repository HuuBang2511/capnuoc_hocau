...
/* @var $searchModel app\modules\quanly\models\danhmuc\DmHieudonghoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Hiệu đồng hồ';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="dm-hieudongho-index">
