...
/* @var $searchModel app\modules\quanly\models\danhmuc\DmLoaimoinoiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Loại mối nối';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="dm-loaimoinoi-index">
