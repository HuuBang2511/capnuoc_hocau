...
/* @var $searchModel app\modules\quanly\models\danhmuc\DmSucoTinhtrangSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Tình trạng sự cố';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="dm-suco-tinhtrang-index">
