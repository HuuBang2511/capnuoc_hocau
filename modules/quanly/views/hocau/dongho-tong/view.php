                    ...
                    <?php if (!empty($files)) : ?>
                        <ul class="list-group list-group-flush">
                            ...
                            <?php
                                ...
                                $dlUrl   = Url::to(['/quanly/hocau/dongho-tong/download-file', 'path' => $file['url']]);
                            ?>
                            <?php if ($isImage) : ?>
...
<script type="module">
    ...
    const donghotong = L.tileLayer.wms('https://cello.capnuochocaumoi.vn/geoserver/capnuoc_hocau/wms', {
