 ...
 * @var app\modules\quanly\models\capnuocgd\GdHamkythuat $model
...
<?php 
    if($model->file_dinhkem != null){
        ...
        foreach($model->file_dinhkem as $i => $item){
            $file[] = Url::to(['/quanly/hocau/nhamaynuoc/download-file', 'path' => $item]);
        }
    }
?>
    ...
    <div class="block block-themed">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'loainhamay_id')->widget(Select2::className(), [
                        'data' => ArrayHelper::map($categories['loainhamay'], 'id', 'ten'),
                        'options' => ['placeholder' => 'Loại nhà máy' ],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                    ]) ?>
...
const overlayers = {
    "Nhà máy nước": L.tileLayer.wms('https://cello.capnuochocaumoi.vn/geoserver/capnuoc_hocau/wms', {
...
function updateGeoJsonInput() {
    ...
    // Chỉ lấy geometry của đối tượng đầu tiên (giả sử chỉ vẽ 1 polygon)
