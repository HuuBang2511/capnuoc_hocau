                            ...
                            'attributes' => [
                                ...
                                [
                                    ...
                                    'value' => function($model){
                                        return ($model->nguyennhansuco_id != null) ? $model->nguyennhansuco->ten : '';
                                    }
                                ],
                                [
                                    'label' => 'Tình trạng sự cố',
                                    'value' => function($model){
                                        return ($model->tinhtrangsuco_id != null) ? $model->tinhtrangsuco->ten : '';
                                    }
                                ],
                                [
                                    'label' => 'Loại sự cố',
                                    'value' => function($model){
                                        return ($model->loaisuco_id != null) ? $model->loaisuco->ten : '';
                                    }
                                ],
                            ],
                        ]) ?>
