...
$wmsUrl = 'http://103.9.77.141:8080/geoserver/capnuoc_hocau/wms';
// SỬA ĐỔI: Đồng nhất URL cho chú thích
$legendWmsUrl = 'http://103.9.77.141:8080/geoserver/capnuoc_hocau/wms';
                ...
                <div class="col-lg-12 p-0"> <!-- Remove padding -->
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            const center = [10.737202088, 106.915000047];
                            const map = L.map('map', {
                            ...
                            const wmsLayersConfig = {
                                "Cọc mốc": { layer: 'capnuoc_hocau:network_cocmoc', visible: true },
                                "Đồng hồ tổng": { layer: 'capnuoc_hocau:network_nhamaynuoc', visible: true },
                            };
                            ...
                            const legendConfig = [
                                { name: 'Đồng hồ tổng', layer: 'capnuoc_hocau:network_donghotong' },
